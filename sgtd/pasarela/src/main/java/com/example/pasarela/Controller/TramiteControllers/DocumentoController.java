...
public class DocumentoController {
	...
	public String DocumentoF(@Validated Documento documento, @RequestParam(value = "tipoDocumento") Long[] id_tipo_documento) { //validar los datos capturados (1)
	...
	public String DocumentoModF(@Validated Documento documento, @RequestParam(value = "tipoDocumento") Long[] id_tipo_documento) { //validar los datos capturados (1)
		for(int i=0;i<id_tipo_documento.length;i++){
            System.out.println(id_tipo_documento[i]);
