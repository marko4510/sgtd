...
public class CertificadoController {
  ...
  public String generarTituloProvisionNacional(@RequestParam("id_persona") Long id_persona, @RequestParam("gestion") String gestion,@RequestParam("nroTitulo") String nroTitulo, Model model) {
    ...
    model.addAttribute("mes", cadenaMesC);
    model.addAttribute("gestion", gestion);
    model.addAttribute("nroTitulo", nroTitulo);

    return "certificado/titulo-academico";
  }
